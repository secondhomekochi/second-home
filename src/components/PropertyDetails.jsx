...
import {
  ...
  PartyPopper, Shield, Droplets, Trash2, CloudRain, Video, Droplet, RockingChair, LandPlot,
...
const PropertyDetails = () => {
  ...
  const icons = [
    ...
    { icon: <LandPlot size={20} />, name: "badminton-court" },
    ...
    { icon: <Droplets size={20} />, name: "borwel-water" },
    { icon: <Droplets size={20} />, name: "corporation-water" },
    ...
    { icon: <RockingChair size={20} />, name: "chairs" },
